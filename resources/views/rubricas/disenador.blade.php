...
<section class="content-header">
    ...
    <ol class="breadcrumb m-2">
        ...
        <li>
            ...
            <a href="/admin/asignaturas/{{$asignatura->id}}/show" class="p-2 btn-link"> < Volver</a>
        </li>
    </ol>
</section>
                ...
                <td style="padding: 0;" colspan="4">
                    ...
                    <div class="d-flex ">
                        ...
                        <div class="col d-flex flex-column  ">
                            ...
                            <div class="d-flex col ">
                                <div class="col-md-2 border-top p-2 d-flex justify-content-center">Corte {{$corte}}</div>
                                ...
                                <div class="d-flex border-top col ">
                                                <div class="col border-end">
                                                    <div class="bg-warning-subtle">
                                                        <div colspan="4" class="text-center">
                                                            No hay RAS para mostrar en este corte. <a href="{{ route('rubrica.editor', $asignatura->id) }}" class="btn btn-link">Quieres editar la rubrica?</a>
                                                        </div>
                                                    </div>
                                                </div>
